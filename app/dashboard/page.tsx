...
import type { Alert } from "@/lib/mock-data-service"
...
export default function DashboardPage() {
  const { equipment, alerts, isLoading } = useMockData()
  ...
  return (
    <ErrorBoundary>
      <div className="space-y-6">
        ...
        <AlertActionDialog alert={selectedAlert} open={alertDialogOpen} onOpenChange={setAlertDialogOpen} />
      </div>
    </ErrorBoundary>
  )
}
